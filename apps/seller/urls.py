...
urlpatterns = [
    ...
    path("products/<int:product_pk>/modules/", views.course_modules, name="course_modules"),
    path("products/<int:product_pk>/modules/<int:module_pk>/lessons/add/", views.lesson_add, name="lesson_add"),
    path("products/<int:product_pk>/modules/<int:module_pk>/delete/", views.module_delete, name="module_delete"),
    path("products/<int:product_pk>/modules/<int:module_pk>/lessons/<int:lesson_pk>/delete/", views.lesson_delete, name="lesson_delete"),
